...
function showSelectRegion() {
  ...
  let opt_spec =
    "<legend>지역 리스트</legend>"
    + "<input type=\"button\" id=\"back_to_main\" value=\"돌아가기\">"
...
function back_to_main() {
  document.getElementById("descriptions").innerHTML = base_description;
}

function region_controller() {
  showSelectRegion();
  const back_btn = document.getElementById("back_to_main");
  const select_rgn_btn = document.getElementById("select_region");
